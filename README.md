...
Beware of running out of heap space! This program is a memory hog. Limiting layer count to only what you need is generally best practice.. With about 4GB of heap space I can safely play with levels with a max size of roughly 2000tiles*2000tiles*20layers.. For a frame of reference, I'm pretty sure a map like say TLOZ - A Link to the Past's overworld could be recreated here with a 256tiles*256tiles*4layers with the right tileset.  
