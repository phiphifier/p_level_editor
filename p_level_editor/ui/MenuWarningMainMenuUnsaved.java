...
public class MenuWarningMainMenuUnsaved extends Menu {
	...
	// CONSTRUCTOR
	public MenuWarningMainMenuUnsaved(Menu owner) {
		super(owner);
		...
		addButtonWithMouseHoverTip(BUTTON_ID_CONFIRM, BUTTON_CONFIRM_X, BUTTONS_Y, BUTTONS_WIDTH, BUTTONS_HEIGHT, "Exit", false, "Proceed with loading this level", HorizontalAlignment.RIGHT);
	}
