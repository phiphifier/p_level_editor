...
import level.LevelDeleter;

public class MenuWarningDeleteLevel extends Menu {

	// VARS
		// INSTANCE FIELDS
	private String bodyText = "Deleted levels can't be restored. Do you still want to proceed?";
	...
	// CONSTRUCTOR
	public MenuWarningDeleteLevel(Menu owner, String levelName) {
		super(owner);
		...
		addButtonWithMouseHoverTip(BUTTON_ID_CONFIRM, BUTTON_CONFIRM_X, BUTTONS_Y, BUTTONS_WIDTH, BUTTONS_HEIGHT, "Delete", false, "Proceed with deleting this level", HorizontalAlignment.RIGHT);
	}
	...
	public void buttonLeftReleased(int buttonID) {
		...
		case BUTTON_ID_CONFIRM: {
			LevelDeleter.remove(levelName);
			MenuLevelSelect myOwner = (MenuLevelSelect)owner;
			myOwner.resetLevelEntryButtons();
